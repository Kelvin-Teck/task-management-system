...
const getReportTime = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const response = yield AnalyticsService.getReportTime(req);
        res.status(200).json((0, apiResponses_1.sendSuccess)("Task Report Time Generated Successfully", response));
    }
    catch (error) {
...
const getCompletedTaskRate = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const response = yield AnalyticsService.getCompletedTaskRate(req);
        res
            .status(200)
            .json((0, apiResponses_1.sendSuccess)("Task Completion Rate Generated Successfully", response));
    }
    catch (error) {
        const status = error instanceof Error && "code" in error ? error.code : 500;
        const errorMessage = error instanceof Error ? error.message : "An unknown error occured";
