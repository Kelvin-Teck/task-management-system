...
const register = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const response = yield AuthService.register(req);
        res.status(200).json((0, apiResponses_1.sendSuccess)("User Created Succesfully", response));
    }
    catch (error) {
...
const login = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const response = yield AuthService.login(req);
        res.status(200).json((0, apiResponses_1.sendSuccess)("User Logged in Successfully", response));
    }
    catch (error) {
        const status = error instanceof Error && "code" in error ? error.code : 500;
        const errorMessage = error instanceof Error ? error.message : "An unknown error occured";
